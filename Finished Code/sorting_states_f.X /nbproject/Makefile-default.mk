...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/sorting_states_2.X_copy.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=bottom_distribution_fsm.c bottom_rocker_fsm.c I2C.c Interrupt_ISR.c lcd.c main.c operation.c solenoids.c top_distribution_fsm.c top_rocker_fsm.c motors.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/bottom_distribution_fsm.p1 ${OBJECTDIR}/bottom_rocker_fsm.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/Interrupt_ISR.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/operation.p1 ${OBJECTDIR}/solenoids.p1 ${OBJECTDIR}/top_distribution_fsm.p1 ${OBJECTDIR}/top_rocker_fsm.p1 ${OBJECTDIR}/motors.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/bottom_distribution_fsm.p1.d ${OBJECTDIR}/bottom_rocker_fsm.p1.d ${OBJECTDIR}/I2C.p1.d ${OBJECTDIR}/Interrupt_ISR.p1.d ${OBJECTDIR}/lcd.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/operation.p1.d ${OBJECTDIR}/solenoids.p1.d ${OBJECTDIR}/top_distribution_fsm.p1.d ${OBJECTDIR}/top_rocker_fsm.p1.d ${OBJECTDIR}/motors.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/bottom_distribution_fsm.p1 ${OBJECTDIR}/bottom_rocker_fsm.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/Interrupt_ISR.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/operation.p1 ${OBJECTDIR}/solenoids.p1 ${OBJECTDIR}/top_distribution_fsm.p1 ${OBJECTDIR}/top_rocker_fsm.p1 ${OBJECTDIR}/motors.p1

# Source Files
SOURCEFILES=bottom_distribution_fsm.c bottom_rocker_fsm.c I2C.c Interrupt_ISR.c lcd.c main.c operation.c solenoids.c top_distribution_fsm.c top_rocker_fsm.c motors.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/sorting_states_2.X_copy.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/sorting_states_2.X_copy.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/sorting_states_2.X_copy.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-fd30-ffff --ram=default,-ef4-eff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/sorting_states_2.X_copy.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/sorting_states_2.X_copy.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/sorting_states_2.X_copy.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/sorting_states_2.X_copy.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/sorting_states_2.X_copy.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
