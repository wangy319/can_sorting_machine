	...
	; Microchip MPLAB XC8 C Compiler V1.40
	...
	;
	; --chip=18F4620 -G \
	; -mdist/Default/production/Lab2-Solution.X.production.map --double=32 \
	; --float=32 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug \
	; --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist \
	...
	; -odist/Default/production/Lab2-Solution.X.production.elf \
	; build/Default/production/SRC/Lab2-Solution.p1 \
	; build/Default/production/SRC/ConfigBits.p1 --ccmode=cci
	;
