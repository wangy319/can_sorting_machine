...
sizeof(sd000),USB_DESCRIPTOR_STRING,{LANGID
}};
...
ROM USB_SERIAL_NUMBER_DESCRIPTOR sd003={
sizeof(USB_SERIAL_NUMBER_DESCRIPTOR),USB_DESCRIPTOR_STRING, USB_SERIAL_DEFAULT_VALUES};
//sizeof(sd003),USB_DESCRIPTOR_STRING, USB_SERIAL_DEFAULT_VALUES};
...
{
    (ROM BYTE *ROM)&sd000,  // Language code string descriptor
    (ROM BYTE *ROM)&sd001,  // Manufacturer string descriptor
    (ROM BYTE *ROM)&sd002,  // Product string descriptor
    (ROM BYTE *ROM)&sd003   // USB serial number string descriptor
};
