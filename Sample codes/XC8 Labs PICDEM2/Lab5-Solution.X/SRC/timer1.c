 ...
 ***************************************************************************/
void TIMER1_initializer (char T1CONvalue,char T1GCONvalue,char TMR1Hvalue,char TMR1Lvalue,char T1INTvalue)
{
...
{
    LATBbits.LATB1 ^= 1;// Add your custom callback code here
}